...
public class OpenAITextEmbeddingGenerationService extends OpenAiService implements TextEmbeddingGenerationService {
    ...
    public static class Builder extends OpenAiServiceBuilder<OpenAITextEmbeddingGenerationService, OpenAITextEmbeddingGenerationService.Builder> {
        @Override
        public OpenAITextEmbeddingGenerationService build() {
            ...
            return new OpenAITextEmbeddingGenerationService(client, deploymentName, modelId, serviceId);
        }
    }
}
